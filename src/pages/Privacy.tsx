        ...
        <article className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              המידע הנאסף משמש למטרות מיפוי צרכים ותכנון. צוות לשכת סגנית ראש העיר ייבחן את הפניות המתקבלות למול שיקולים נוספים בתכנון המרחב הציבורי, ויפעל לענות על הצורך ככל הניתן. דיווח בקשות בממשק זה, אינו תחליף לדיווח פניה במוקד 106 העירוני, ואף מומלץ לדווח ב-2 המערכות במקביל.
            </p>
          </section>
